...
public class DatabaseProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, DatabaseContract.MOVIE_PATH, MOVIE);
        matcher.addURI(authority, DatabaseContract.MOVIE_PATH + "/#", MOVIE_ID);
        ...
        switch (sUriMatcher.match(uri)) {
            case MOVIE_ID: {
                retCursor = mOpenHelper.getReadableDatabase().query(
                        ...
                        projection,
                        DatabaseContract.MovieEntry._ID + " = '" + ContentUris.parseId(uri) + "'",
                        null,
                        null,
                        null,
                        sortOrder
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case MOVIE:
                rowsUpdated = db.update(DatabaseContract.MovieEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
